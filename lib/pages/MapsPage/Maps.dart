...
class _MyAppState extends State<MapsPage> {
  ...
  Set<Marker> _markers = markers[category];
  ...
  _openSearchFilter(String cat) {
    setState(() {
      category = cat;
      _markers = markers[category];
    });
  }
